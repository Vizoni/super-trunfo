...
export function Game({players} : {players: PlayerInTheRoom[]}) {
	
    
    const [users, setUsers] = useState<PlayerInTheRoom[]>([])
    ...
    function startGame() {
        ...
        setPlayer1Deck(shuffledCards.slice(halfOfDeckAmount,Math.trunc(shuffledCards.length / 2)))
    }
